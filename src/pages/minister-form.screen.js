...
import { getMinisterById, saveMinister, updateMinister } from '../services/ministers.service';
...
class MinisterForm extends React.Component {
    ...
    async componentDidMount() {
        ...
        if (pathname == '/ministers/register') {

        } else if (pathname.startsWith('/ministers')) {
    ...
    async saveMinister(minister) {
        ...
        if (minister.id) {
            return updateMinister(minister.id, minister)
        } else {
            delete minister.id
            return saveMinister(minister)
        }
    }
            ...
            <Aux>
                <Row>
                    <Col md={12}>
                        <Card>
                            <Card.Header>
                                <Card.Title as="h5">cadastro ministério</Card.Title>
                            </Card.Header>
                            <Card.Body>
                                <Formik
