...
class Breadcrumb extends Component {
    ...
    render() {
        ...
        if (this.state.main && this.state.main.type === 'collapse') {
            main = (
                <li className="breadcrumb-item">
                    <a href={DEMO.BLANK_LINK} style={{color: '#fff'}}>{this.state.main.title}</a>
                </li>
            );
        }
        ...
        if (this.state.item && this.state.item.type === 'item') {
            ...
            item = (
                <li className="breadcrumb-item">
                    <a href={DEMO.BLANK_LINK} style={{color: '#fff'}}>{title}</a>
                </li>
            );
                            ...
                            <div className="row align-items-center">
                                <div className="col-md-12">
                                    <ul className="breadcrumb">
                                        <li className="breadcrumb-item">
                                            <Link to="/"><i className="feather icon-home" style={{color: '#fff'}}/></Link>
                                        </li>
                                        {main}
                                        {item}
                                    </ul>
